//
//  TableViewControllerTrips.swift
//  TripGallery
//
//  Created by Andrew Bellamy on 3/5/17.
//  Copyright © 2017 Andrew Bellamy. All rights reserved.
//

import UIKit

class TableViewControllerTrips: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "segueTripDetails") {
            (segue.destination as! TableViewControllerTripInfo).trip = (sender as! Trip)
        }
    }
